...
SI=Sys.info()
if(SI[[1]] == "Linux"){
  Tdir = "/home/estimr3/ccadiou/Winter/ERA5/" ## Needs to be adapted
  OUTdir="/home/estimr3/ccadiou/Winter/WEGE/" ## Needs to be adapted
}
if(SI[[1]] == "Darwin"){
...
## entre decembre et janvier
      diff.ana.cal.1 = abs(ana.d1.cal - ((t0.cal+i)%%366))
...
## Modification par C. Cadiou (09/06/2022)
      obs.dates = as.numeric(format(seq(as.Date(as.character(t.start),format="%Y%m%d"),
